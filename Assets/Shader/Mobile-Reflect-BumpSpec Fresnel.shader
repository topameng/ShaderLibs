Shader "Topameng/Reflective/Bumped Specular Fresnel" 
{
	Properties 
	{		
	...
	{ 
		...
		void surf (Input IN, inout _SurfaceOutput o) 
		{
			...
			fixed VdotH = max(0, dot(IN.viewDir, o.Normal));		
			fixed fresnel = Fresnel(VdotH, _Fresnel, 5);;	
			o.Emission = reflcol.rgb * spec.rgb * fresnel * _ReflStrength;					
		}
